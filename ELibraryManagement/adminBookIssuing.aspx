                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col">
                                    <center>
                                        <img width="100" class="img-fluid" src="img/imgs/books.png" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <asp:Button for="TextBox1" class="btn btn-primary mx-1 px-2 py-1 font-weight-bold rounded-circle" ID="Button1" runat="server" Text="GO" OnClick="Button1_Click" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
