                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img id="imgview" class="img-fluid" width="100" src="book_inventory/books.png" />
                                </center>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <asp:Button class=" btn btn-primary mx-1 px-2 py-1 font-weight-bold rounded-circle" ID="Button4" runat="server" Text="Go" OnClick="Button4_Click" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-8">
