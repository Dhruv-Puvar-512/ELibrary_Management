...
namespace ELibraryManagement
{
    public partial class usersignup : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>alert('Member Already Exists with this User ID ,try other User ID');</script>");
            }
            else
            {
                signUpNewUser();
        ...
        bool checkMemberExists()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * from member_master_tbl where member_id='" + tbUserid.Text.Trim() + "';", con);
        ...
        void signUpNewUser()
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@full_name", tbName.Text.Trim());
